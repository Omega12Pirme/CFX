...
event ProposalCreated(
    ...
    function getClubById(uint256 clubId) public view returns (ClubInfo memory) {
        ...
        ClubInfo memory club = ClubInfo(clubReal.id, clubReal.name, clubReal.memberCounter, clubReal.proposalCounter, clubReal.pool,clubReal.CID);
        return club;
    }
    ...
    function listClubs() public view returns (ClubInfo[] memory) {
        ...
        for (uint256 i = 0; i < clubCounter; i++) {
            ...
            clubList[i] = ClubInfo(club.id, club.name, club.memberCounter, club.proposalCounter, club.pool,club.CID);
        }
