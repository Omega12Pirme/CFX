...
export class ProposalInfoEvent extends ethereum.Event {
  get params(): ProposalInfoEvent__Params {
    return new ProposalInfoEvent__Params(this);
  }
}

export class ProposalInfoEvent__Params {
  _event: ProposalInfoEvent;

  constructor(event: ProposalInfoEvent) {
    this._event = event;
  }
...
export class GetMyClubsCall extends ethereum.Call {
  get inputs(): GetMyClubsCall__Inputs {
    return new GetMyClubsCall__Inputs(this);
  }

  get outputs(): GetMyClubsCall__Outputs {
    return new GetMyClubsCall__Outputs(this);
  }
}

export class GetMyClubsCall__Inputs {
  _call: GetMyClubsCall;

  constructor(call: GetMyClubsCall) {
    this._call = call;
  }
}

export class GetMyClubsCall__Outputs {
  _call: GetMyClubsCall;
  ...
  get value0(): Array<GetMyClubsCallValue0Struct> {
    return this._call.outputValues[0].value.toTupleArray<GetMyClubsCallValue0Struct>();
  }
}

export class GetMyClubsCallValue0Struct extends ethereum.Tuple {
  get clubId(): BigInt {
    return this[0].toBigInt();
  }
...
export class GetProposalByIdCall extends ethereum.Call {
  get inputs(): GetProposalByIdCall__Inputs {
    return new GetProposalByIdCall__Inputs(this);
  }

  get outputs(): GetProposalByIdCall__Outputs {
    return new GetProposalByIdCall__Outputs(this);
  }
}

export class GetProposalByIdCall__Inputs {
  _call: GetProposalByIdCall;

  constructor(call: GetProposalByIdCall) {
    this._call = call;
  }
...
export class GetProposalByIdCall__Outputs {
  _call: GetProposalByIdCall;
  ...
  get value0(): GetProposalByIdCallValue0Struct {
    return changetype<GetProposalByIdCallValue0Struct>(
      this._call.outputValues[0].value.toTuple(),
    );
  }
}

export class GetProposalByIdCallValue0Struct extends ethereum.Tuple {
  get id(): BigInt {
    return this[0].toBigInt();
  }
